<tr>
<td>
  <table class="footer" align="center" width="600" cellpadding="0" cellspacing="0" role="presentation" style="width:600px;max-width:600px;">
    <tr>
      <td align="center" style="padding:22px 10px 8px;">
        ...
        <p style="margin:0;font-size:11px;color:#aab2c2;line-height:1.6;">
          ...
          @if(!empty($unsubscribe_url)) <a href="{{ $unsubscribe_url }}" style="color:#3b5bdb;text-decoration:underline;">Unsubscribe</a>. @endif
        </p>
      </td>
    </tr>
  </table>
