...
<style>
  @media only screen and (max-width: 600px) {
    .email-shell, .inner-body, .footer { width: 100% !important; }
    .content-cell { padding: 28px 22px !important; }
  }
  @media (prefers-reduced-motion: no-preference) {
    .email-card { animation: enzoFadeUp .6s cubic-bezier(.2,.8,.2,1) both; }
      ...
      <table class="email-shell" width="600" cellpadding="0" cellspacing="0" role="presentation" style="width:600px; max-width:600px;">
        <tr>
          <td class="email-card" style="border-radius:16px; overflow:hidden; box-shadow:0 14px 38px rgba(11,31,77,0.14); background-color:#ffffff;">
            {{ $header ?? '' }}
            <table class="inner-body" align="center" width="600" cellpadding="0" cellspacing="0" role="presentation" style="width:600px; background-color:#ffffff; border-radius:0 0 16px 16px;">
              <tr>
