...
<div class="d-lg-none mobile-dashboard">
    ...
    <div class="mobile-lock-card" style="background:var(--bg-elevated);border:1px solid var(--border-color);border-left:3px solid var(--blue);border-radius:12px;padding:16px;margin:16px 0;">
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:8px;">
            ...
            <span style="font-size:15px;font-weight:600;color:var(--text-primary);">Unlock Full Access</span>
        </div>
        <p style="font-size:13px;color:var(--text-secondary);line-height:1.6;margin-bottom:12px;">
            Make your first crypto deposit to:
        </p>
        <div style="display:flex;flex-direction:column;gap:4px;margin-bottom:12px;font-size:13px;color:var(--text-secondary);">
...
<div class="dashboard-grid pt-3 d-none d-lg-grid">
    ...
    <div class="premium-dashboard-container" style="grid-column:1/-1;">
        <div style="background:var(--bg-elevated);border:1px solid var(--border-color);border-left:4px solid var(--blue);border-radius:16px;padding:24px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px;">
