...
<div class="am-body" style="padding-top:60px;display:flex;flex-direction:column;align-items:center;gap:24px;">
    <!-- Success Animation -->
    <div style="width:80px;height:80px;border-radius:50%;background:rgba(16,185,129,0.1);display:flex;align-items:center;justify-content:center;animation: scaleUp 0.5s ease-out;">
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#059669" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="animation: drawCheck 0.6s ease-out 0.2s forwards;stroke-dasharray:50;stroke-dashoffset:50;">
    ...
    <div style="text-align:center;">
        ...
        <div style="font-size:14px;color:#6B7280;margin-top:8px;">Your deposit is under review. You'll be notified once confirmed.</div>
    </div>
    ...
    <div class="am-card" style="width:100%;">
        ...
        <div class="am-preview-row"><span class="am-preview-label">✅ Expected Return</span><span class="am-preview-value" style="color:#059669;">${{ number_format($investment->expected_return ?? 0, 2) }}</span></div>
        <div class="am-preview-row"><span class="am-preview-label">📊 Status</span><span class="am-preview-value"><span style="padding:3px 12px;border-radius:20px;background:rgba(245,158,11,0.1);color:#D97706;font-size:12px;font-weight:600;">{{ ucfirst($investment->status ?? 'pending') }}</span></span></div>
    </div>
