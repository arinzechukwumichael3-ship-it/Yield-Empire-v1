...
<nav class="glass-nav" role="navigation" aria-label="Main navigation">
    <div class="glass-nav-inner">
        <a href="{{ route("user.rise.home") }}" class="glass-nav-item {{ request()->routeIs("user.rise.home") ? "active" : "" }}" aria-label="Home">
        ...
        <a href="{{ route("user.rise.invest") }}" class="glass-nav-item {{ request()->routeIs("user.rise.invest") ? "active" : "" }}" aria-label="Invest">
        ...
        <a href="{{ route("user.rise.feed") }}" class="glass-nav-item {{ request()->routeIs("user.rise.feed") ? "active" : "" }}" aria-label="Feed">
        ...
        <a href="{{ route("user.rise.account") }}" class="glass-nav-item glass-nav-avatar {{ request()->routeIs("user.rise.account") ? "active" : "" }}" aria-label="Account">
