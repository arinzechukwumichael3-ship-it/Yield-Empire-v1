...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            \App\Http\Middleware\SkipInstaller::class,
            ...
            \App\Http\Middleware\SecurityHardening::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        'api.kyc.verification.guard'    => \App\Http\Middleware\Api\V1\User\KycVerificationGuard::class,
