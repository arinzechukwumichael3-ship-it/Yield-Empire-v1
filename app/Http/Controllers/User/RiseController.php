...
class RiseController extends Controller
{
    ...
    public function home()
    {
        ...
        // Today-only activity used for the "Today" P&L badge on the dashboard.
        $todayTransactions = Transaction::auth()
    ...
    private function processInternalTransfer(Request $request)
    {
        ...
        if ($user->bankDetails->where('status', 1)->count() === 0) {
            return back()->with(['error' => ['You must add your bank details before you can send money to another YieldEmpire account. Please add your bank details first.']])->withInput();
        }
        ...
        try {
            ...
            Transaction::create([
                ...
                'details'         => json_encode([
                    ...
                    'sender_bank'   => 'YieldEmpire',
                    'receiver_name' => $recipient->fullname,
                    'receiver_email'=> $recipient->email,
                    'receiver_bank' => 'YieldEmpire',
    ...
    /**
     * YieldEmpire -> any other international bank. The user supplies the
    ...
    private function getStaticArticles(): Collection
    {
        return collect([
            (object)[
                'title' => 'YieldEmpire Launches Premium Credit Cards with Unlimited Rewards',
                'slug' => 'yieldempire-premium-credit-cards',
                'data' => (object)[
                    'description' => "YieldEmpire is proud to announce the launch of our Premium Credit Card line, offering unlimited cashback rewards, zero foreign transaction fees, and exclusive airport lounge access worldwide. Available to qualifying users starting July 2026, the card features a titanium build, contactless payment, and integrated digital wallet support. Apply directly from your YieldEmpire dashboard and get a decision in under 60 seconds.",
            ...
            (object)[
                ...
                'slug' => 'yieldempire-app-update-july',
                'data' => (object)[
                    'description' => "The latest YieldEmpire mobile app update (v3.2) brings biometric fingerprint and face ID login, system-wide dark mode, and real-time push notifications for all transactions. The update also includes performance improvements making the app 40% faster on older devices. Available now on iOS App Store and Google Play Store.",
            ...
            (object)[
                'title' => 'How to Grow Your Wealth with YieldEmpire Investment Plans',
                'slug' => 'yieldempire-investment-plans',
                'data' => (object)[
                    'description' => "Our investment plans offer competitive returns starting from 15% ROI. Whether you are a beginner or seasoned investor, YieldEmpire has a plan that fits your risk tolerance and financial objectives. Features include automatic rebalancing, tax-loss harvesting, and goal-based tracking.",
            ...
            (object)[
                ...
                'data' => (object)[
                    'description' => "Our Q3 2026 playbook highlights five sectors poised for growth: AI infrastructure, renewable energy storage, healthcare innovation, cybersecurity, and consumer staples. AI infrastructure stocks lead with 25%+ projected growth. Full analysis is available to YieldEmpire Premium subscribers.",
            ...
            (object)[
                'title' => 'YieldEmpire Introduces Fractional Share Trading for Everyone',
                'slug' => 'fractional-share-trading-launch',
                'data' => (object)[
                    'description' => "YieldEmpire now offers fractional share trading, allowing investment in any stock or ETF with as little as \$1. Build a diversified portfolio even with small amounts, invest in high-priced stocks like Berkshire Hathaway and Nvidia, and easily implement dollar-cost averaging.",
            ...
            (object)[
                ...
                'data' => (object)[
                    'description' => "With the April 15 deadline approaching, our tax experts cover tax-loss harvesting, qualified dividend treatment, capital gains holding periods, and crypto reporting requirements. Use YieldEmpire tax document center to streamline your filing process and maximize deductions.",
            ...
            (object)[
                'title' => 'YieldEmpire Launches Green Bond Fund for Sustainable Investors',
                'slug' => 'yieldempire-green-bond-fund',
                'data' => (object)[
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #1E293B, #4B5563)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0035/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0037/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0040/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
                'created_at' => \Carbon\Carbon::parse('2025-08-15'),
            ],
            (object)[
                'title' => 'YieldEmpire Launches Youth Banking Accounts for Teens',
                'slug' => 'yieldempire-youth-banking-teens',
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #7C3AED, #A78BFA)',
                    'thumb_icon' => 'card',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0041/400/300',
                ],
                'category' => (object)['name' => 'Company updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0042/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_icon' => 'globe',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0043/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                'title' => 'YieldEmpire Spring 2025 Release: 12 New Features',
                'slug' => 'yieldempire-spring-2025-release',
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #2563EB, #7C3AED)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0045/400/300',
                ],
                'category' => (object)['name' => 'Company updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #92400E, #D97706)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0046/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
                'created_at' => \Carbon\Carbon::parse('2025-04-28'),
            ],
            (object)[
                'title' => 'YieldEmpire Launches Automated Savings Rules Engine',
                'slug' => 'yieldempire-savings-rules-engine',
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #0F766E, #2DD4BF)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0047/400/300',
                ],
                'category' => (object)['name' => 'Company updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    'description' => "Private credit has emerged as a compelling alternative asset class with yields of 8-12%. Our analysis covers direct lending, mezzanine debt, and distressed opportunities for accredited investors through YieldEmpire alternative investments platform.",
                    'thumb_gradient' => 'linear-gradient(135deg, #5B21B6, #A78BFA)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0048/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
                'created_at' => \Carbon\Carbon::parse('2025-03-20'),
            ],
            (object)[
                'title' => 'YieldEmpire Expands Crypto Offerings with New Tokens',
                'slug' => 'yieldempire-crypto-expansion-2025',
                'data' => (object)[
                    'description' => "YieldEmpire crypto trading platform now supports 60+ cryptocurrencies including Solana, Cardano, Polkadot, and Chainlink. New features include staking rewards, crypto-backed loans, and automated portfolio rebalancing across digital assets.",
                    'thumb_gradient' => 'linear-gradient(135deg, #92400E, #F59E0B)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0049/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #1E3A8A, #3B82F6)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0050/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0052/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #92400E, #F59E0B)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0053/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #1E293B, #4B5563)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0055/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0057/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0059/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
                'created_at' => \Carbon\Carbon::parse('2024-08-25'),
            ],
            (object)[
                'title' => 'YieldEmpire Summer 2024 Feature Release Highlights',
                'slug' => 'yieldempire-summer-2024-features',
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #2563EB, #60A5FA)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0060/400/300',
                ],
                'category' => (object)['name' => 'Company updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #B45309, #F59E0B)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0061/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
                'created_at' => \Carbon\Carbon::parse('2024-07-20'),
            ],
            (object)[
                'title' => 'YieldEmpire Launches Premium Savings Challenge Feature',
                'slug' => 'yieldempire-savings-challenge',
                'data' => (object)[
                    ...
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0062/400/300',
                ],
                'category' => (object)['name' => 'Company updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #1E3A8A, #60A5FA)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0063/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
                'created_at' => \Carbon\Carbon::parse('2024-06-30'),
            ],
            (object)[
                'title' => 'YieldEmpire Introduces Joint Accounts for Couples',
                'slug' => 'yieldempire-joint-accounts-launch',
                'data' => (object)[
                    'description' => "YieldEmpire launches joint checking and savings accounts for couples and families. Features include shared budgeting tools, goal-based savings, individual privacy settings, and seamless transfers between joint and personal accounts.",
                    'thumb_gradient' => 'linear-gradient(135deg, #BE185D, #EC4899)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0064/400/300',
                ],
                'category' => (object)['name' => 'Company updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #7C3AED, #A78BFA)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0065/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #1E293B, #475569)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0067/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #B91C1C, #FCA5A5)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0069/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #1E3A8A, #2563EB)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0070/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #1E293B, #64748B)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0073/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
            ...
            (object)[
                ...
                'data' => (object)[
                    'description' => "Dollar-cost averaging is one of the most effective investment strategies. By investing a fixed amount regularly, you buy more when prices are low and fewer when high. Learn how to set up automated DCA with YieldEmpire.",
                    'thumb_gradient' => 'linear-gradient(135deg, #0F766E, #2DD4BF)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0074/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_icon' => 'globe',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0075/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #16A34A, #22C55E)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0079/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #7C3AED, #A78BFA)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0080/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0082/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #92400E, #F59E0B)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0085/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #1E3A8A, #3B82F6)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0086/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #DC2626, #EF4444)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0088/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0090/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #0F766E, #5EEAD4)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0092/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
            ...
            (object)[
                ...
                'data' => (object)[
                    'description' => "Our 2026 back-to-school guide covers education savings strategies, 529 plan optimization, student loan planning, and budgeting for expenses. YieldEmpire tools help you prepare for every education stage.",
                    'thumb_gradient' => 'linear-gradient(135deg, #7C3AED, #A78BFA)',
                    'thumb_icon' => 'default',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0094/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
                'created_at' => \Carbon\Carbon::parse('2026-08-05'),
            ],
            (object)[
                'title' => 'Carbon Footprint Tracker: YieldEmpire Green Initiative',
                'slug' => 'yieldempire-carbon-footprint-tracker',
                'data' => (object)[
                    'description' => "YieldEmpire new carbon footprint tracker analyzes your spending to estimate environmental impact. Get personalized suggestions for reducing your footprint, carbon offsets, and green investment recommendations.",
                    'thumb_gradient' => 'linear-gradient(135deg, #16A34A, #22C55E)',
                    'thumb_icon' => 'globe',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0095/400/300',
                ],
                'category' => (object)['name' => 'Company updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #D97706, #FBBF24)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0096/400/300',
                ],
                'category' => (object)['name' => 'Portfolio reports'],
                'created_at' => \Carbon\Carbon::parse('2026-07-28'),
            ],
            (object)[
                'title' => 'YieldEmpire Launches Premium Travel Insurance for Cardholders',
                'slug' => 'yieldempire-travel-insurance',
                'data' => (object)[
                    'description' => "YieldEmpire Premium cardholders now receive comprehensive travel insurance including trip cancellation, lost luggage, rental car coverage, and emergency medical evacuation. Coverage is automatic with no enrollment needed.",
                    'thumb_gradient' => 'linear-gradient(135deg, #1E3A8A, #60A5FA)',
                    'thumb_icon' => 'card',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0097/400/300',
                ],
                'category' => (object)['name' => 'Company updates'],
            ...
            (object)[
                ...
                'data' => (object)[
                    ...
                    'thumb_gradient' => 'linear-gradient(135deg, #5B21B6, #8B5CF6)',
                    'thumb_icon' => 'globe',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0099/400/300',
                ],
                'category' => (object)['name' => 'Market updates'],
                'created_at' => \Carbon\Carbon::parse('2026-07-18'),
            ],
            (object)[
                'title' => 'YieldEmpire Launches Automated Portfolio Rebalancing',
                'slug' => 'yieldempire-auto-rebalancing',
                'data' => (object)[
                    'description' => "YieldEmpire introduces automatic portfolio rebalancing that brings your asset allocation back to target whenever it drifts beyond your chosen threshold. Customize rebalancing frequency, bands, and tax optimization preferences.",
                    'thumb_gradient' => 'linear-gradient(135deg, #2563EB, #1D4ED8)',
                    'thumb_icon' => 'chart',
                    'thumb_url' => 'https://picsum.photos/seed/yieldempire-article-0100/400/300',
                ],
                'category' => (object)['name' => 'Company updates'],
